...
//        System.out.println(searchKeyword("부동산"));
        ...
        for(int i=0;i<responseBody.length();i++) {
        	System.out.println(responseBody.valueOf(i));
        }
    }
    ...
    public static String searchKeyword(String keyword) {
        ...
        Map<String, String> requestHeaders = new HashMap<>();
        requestHeaders.put("X-Naver-Client-Id", "qfw1q1eJUJnozhkzJZMv");
        requestHeaders.put("X-Naver-Client-Secret", "WZlZsxT4FY");
        String responseBody = get(apiURL, requestHeaders);
