        ...
        <aside class="col-4">
          ...
          <div class="mt-4 overflow-auto" style="height: 650px">
            <div
              ...
              id="aside-list-info"
            ></div>
            <div id="aside-list" class=""></div>
          </div>
          <div class="mt-3" id="deal-back-btn" style="display: none">
            <button
              type="button"
              class="btn btn-dark bg-common-dark w-100"
              onclick="getHomes('${dongCode}')"
            >
              돌아가기
            </button>
          </div>
...
export default {
  mounted() {
    if (window.kakao && window.kakao.maps) {
      ...
      script.src =
        "//dapi.kakao.com/v2/maps/sdk.js?appkey=75437cf1f37f10da78850c28ba706d18&libraries=services";
